...
export, settings, a web-matching Reports placeholder, and an offline manual income/expense outbox. Transaction capture preserves a user-selected effective date while confirmed balances remain server-owned. Group direct expenses preserve their selected effective date too. Access
