...
- [Mobile/web surface parity walkthrough](../reviews/2026-09-01-mobile-web-surface-parity-walkthrough.md)
...
- [Mobile workspace authorization fallback walkthrough](../reviews/2026-09-02-mobile-workspace-authorization-fallback-walkthrough.md)
...
- [Mobile Expo Go QR smoke-test walkthrough](../reviews/2026-09-02-mobile-expo-go-qr-walkthrough.md)
...
| [04. Classification/budgets/reporting](phases/04-CLASSIFICATION-BUDGETING-REPORTING.md) | Report projection complete | Budget buckets/tags/monthly plan editor, permission-filtered report projections, and report UI work; rollover persistence and chart/export polish remain |
